...
def cooldown(period: Period) -> typing.Callable[
  ['contexts.Context'],
  typing.Awaitable[typing.Optional[
    crescent.HookResult
  ]]
]:
  total = period.total
  ...
  async def inner(context: 'contexts.Context') -> typing.Optional[crescent.HookResult]:
